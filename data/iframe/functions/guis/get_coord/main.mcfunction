...
execute if data storage iframe:io inv[{Slot:-106b}].tag{iframe:"get_coord_button"} run function iframe:guis/get_coord/f_output
execute unless data storage iframe:io inv[].tag{iframe:"get_coord_button"} run function iframe:gui_stack/_pop
execute unless data storage iframe:io selecteditem.tag{iframe:"get_coord_button"} run scoreboard players set update_gui int 1
execute if data storage iframe:io selecteditem.tag{iframe:"get_coord_button"} if score @s iframe_rc matches 1.. run function iframe:guis/get_coord/rc_output
